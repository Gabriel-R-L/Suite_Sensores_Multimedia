...
public class CalculadoraReact extends Fragment {
    public CalculadoraReact() {
        // Required empty public constructor
    }

    public static CalculadoraReact newInstance() {
        return new CalculadoraReact();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_calculadora_react, container, false);
